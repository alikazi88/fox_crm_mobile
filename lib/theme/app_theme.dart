...
class AppTheme {
  ...
  static ThemeData estateLightTheme = createTheme(
    ColorScheme.fromSeed(
        seedColor: Color(0xffffac5c),
        primaryContainer: Color(0xffffac5c),
        secondary: Color(0xfff15f5f),
        onSecondary: Color(0xffffffff),
        secondaryContainer: Color(0xfff8d6d6),
        onSecondaryContainer: Color(0xFFFFFA726)),
  );
  static ThemeData estateDarkTheme = createTheme(
    ColorScheme.fromSeed(
        seedColor: Color(0xffcaffff),
        primary: Color(0xffffac5c),
  ...
  static ThemeData learningDarkTheme = createTheme(
    ColorScheme.fromSeed(
        ...
        onPrimary: Color(0xffFFB155),
        primaryContainer: Color(0xffFFB155),
  ...
  static ThemeData getShoppingManagerTheme() {
    return createThemeM3(themeType, Color(0xffFFB155));
  }
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
        ...
        elevation: 4,
        focusColor: Color(0xffFFB155),
        hoverColor: Color(0xffFFB155),
    ...
    tabBarTheme: TabBarTheme(
      ...
      labelColor: Color(0xffFFB155),
      indicatorSize: TabBarIndicatorSize.label,
      indicator: UnderlineTabIndicator(
        borderSide: BorderSide(color: Color(0xffFFB155), width: 2.0),
      ),
    ),
    ...
    checkboxTheme: CheckboxThemeData(
      ...
      fillColor: MaterialStateProperty.all(Color(0xffFFB155)),
    ),
    ...
    sliderTheme: SliderThemeData(
      activeTrackColor: Color(0xffFFB155),
      inactiveTrackColor: Color(0xffFFB155).withAlpha(140),
      trackShape: RoundedRectSliderTrackShape(),
      trackHeight: 4.0,
      thumbColor: Color(0xffFFB155),
    ...
    colorScheme: ColorScheme.fromSeed(seedColor: Color(0xffFFB155), brightness: Brightness.light)
