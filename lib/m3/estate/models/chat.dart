...
class Chat {
  final String name, image, chat, messages;
  final bool replied;

  Chat(
      this.name, this.image, this.chat, this.messages, this.replied);
  ...
  static Chat fromJson(Map<String, dynamic> jsonObject) {
    ...
    return Chat(name, image, chat, messages, replied);
  }
  ...
  static Chat getOneDummy() {
    return Chat('Dr. Anna Handy', 'assets/images/profile/avatar_5.jpg',
        'Hello, when will you be available?', '2', true);
  }
}
