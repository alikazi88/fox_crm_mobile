...
import 'shopping_setup_screen.dart';
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 30),
                              FxText.bodyLarge(
                                  'Add Your Business Contacts Easily',
                                  fontWeight: 700),
                              SizedBox(height: 16),
                              FxText(
                                  'Effortlessly add and manage your business contacts with our platform.',
                                  fontWeight: 500),
                            ],
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 30),
                              FxText.bodyLarge('Manage your contacts',
                                  fontWeight: 700),
                              SizedBox(height: 16),
                              FxText.bodyMedium(
                                  'Effortlessly organize and streamline your contacts with ease.',
                                  fontWeight: 500)
                            ],
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 30),
                              FxText.bodyLarge('Connect with your contacts',
                                  fontWeight: 700),
                              SizedBox(height: 16),
                              FxText.bodyMedium(
                                  'Easily connect with your contacts using our streamlined contact management system.',
                                  fontWeight: 500),
                            ],
                          ),
                        ),
